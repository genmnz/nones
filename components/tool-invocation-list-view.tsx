...
const FlightTracker = dynamic(() => import('@/components/tools/flight-tracker').then(mod => mod.FlightTracker), { ssr: false });
...
const TMDBResult = dynamic(() => import('@/components/tools/movie-info'), { ssr: false });
...
const TrendingResults = dynamic(() => import('@/components/tools/trending-tv-movies-results'), { ssr: false });
const AcademicPapersCard = dynamic(() => import('@/components/search/academic-papers'), { ssr: false });
const WeatherChart = dynamic(() => import('@/components/tools/weather-chart'), { ssr: false });
const InteractiveStockChart = dynamic(() => import('@/components/charts/interactive-stock-chart'), { ssr: false });
const CurrencyConverter = dynamic(() => import('@/components/tools/currency_conv').then(mod => mod.CurrencyConverter), { ssr: false });
