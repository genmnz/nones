...
const MapComponent = memo(({ center, places = [], zoom = 14, onMarkerClick, height = "h-[400px]", className = "" }: MapProps) => {
  ...
  if (mapError) {
    return (
      <div className={`w-full ${height} flex items-center justify-center bg-neutral-50 dark:bg-neutral-900 rounded-lg ${className}`}>
